...
| [M0 completion notes](docs/progress/m0-completion.md) | What was actually implemented for M0, what was verified, what is deferred to hardware, and deviations from the brief |
...
- **Engine: Godot 4.7.2, GDScript, 2D.** It is the only candidate that ships official Windows x86_64 *and* Linux arm64 export templates from one project, and its SDL-backed gamepad layer handles the four-controller requirement without custom code.
